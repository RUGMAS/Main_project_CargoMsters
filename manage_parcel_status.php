<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Waiting","Collected","Shipped","In-Transit","Arrived At Destination","Out for Delivery","Ready to Pickup","Delivered","Picked-up","Unsuccessfull Delivery Attempt","Approve"); ?>
