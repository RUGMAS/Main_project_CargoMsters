	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_price"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$qry = $conn->query("SELECT * FROM prices  ");
					...
					<tr>
						...
						<td><b><?php echo $row['width_from'] ?>-<?php echo $row['width_to'] ?></b></td>
...
<script>
	$(document).ready(function(){
		...
		$('.view_branch').click(function(){
			uni_modal("Price's Details","view_branch.php?id="+$(this).attr('data-id'),"large")
		})
	$('.delete_branch').click(function(){
	_conf("Are you sure to delete this Prices?","delete_branch",[$(this).attr('data-id')])
	})
	})
